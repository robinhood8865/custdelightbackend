...
const connectBase = async (req, res) => {
  ...
  const { airtableBaseID, airtableAPIKey } = req.body;
  console.log("🚀 ~ file: airtable.js:147 ~ connectBase ~ req.body", req.body);

  const myBase = new Airtable({
    // apiKey: "keyZo3Y0Rrb662fzT",
    apiKey: airtableAPIKey,
  }).base(airtableBaseID);
  console.log("🚀 ~ file: airtable.js:152 ~ connectBase ~ myBase", myBase);
